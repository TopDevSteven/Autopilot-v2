...
export class ReportMDRService {
  ...
  async displayCleanupListsToSheet(allShops: allShopObject) {
        ...
        if (Number(customer.wsid) === wowShopId) {
          ...
          if (authDate < date48MosAgo) {
            ...
            if (isMailable === true) {
              ...
              acc[wowShopId].processedCustomersUnder48.push(customer);
            }
    ...
    //   ...accuzipCounts[1023].processedCustomersOver48,
    //   ...accuzipCounts[1024].processedCustomersOver48,
    //   ...accuzipCounts[1025].processedCustomersOver48,
    //   ...accuzipCounts[1026].processedCustomersOver48,
    // ]);
