...
export class MailinglistWriteAccuzipToDBService {
  ...
  async readAndWriteAccuzipCustomers() {
    ...
    res = res.filter((c) => c.software === "nap");

    console.log(res);

    // res = res.filter((c) => c.shopName === "Primary Care Auto Repair");

    // console.log(res);
    // res.forEach((customer) => {
    //   if (customer.wsId.trim() == "5001") {
    //     customer.wsId = "5004";
    //   }

    //   if (customer.wsId.trim() == "5002") {
    //     customer.wsId = "5005";
    //   }

    //   if (customer.wsId.trim() == "5003") {
    //     customer.wsId = "1065";
    //   }

    //   if (customer.wsId.trim() == "5004") {
    //     customer.wsId = "1066";
    //   }

    //   if (customer.wsId.trim() == "5005") {
    //     customer.wsId = "1067";
    //   }

    //   if (customer.wsId.trim() == "5006") {
    //     customer.wsId = "1064";
    //   }

    //   if (customer.wsId.trim() == "5007") {
    //     customer.wsId = "5003";
    //   }

    //   if (customer.wsId.trim() == "5008") {
    //     customer.wsId = "5001";
    //   }

    //   if (customer.wsId.trim() == "5009") {
    //     customer.wsId = "5002";
    //   }
    // });
